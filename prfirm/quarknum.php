<?php 
	...
	$query = 'SELECT * FROM prfirm WHERE (country = "" or isnull(country)) and inactive = 0 and alpha between "0" and "9" and isnull(organization) ORDER BY name';
