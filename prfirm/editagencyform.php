<?php
	...
	{		
		...
		echo "</html>";
				...
				$query = 'SELECT id, name, agencystatement FROM prfirm WHERE `id` = "' .$_GET['id'].'"';
				$i=0;
...
<input type="hidden" name="currentid" value="agency">
...
<tr class="ssi-text">
    <td>Agency Statement:</td>
    <td></td>
</tr>
<tr class="ssi-text">
    <td colspan="2"><textarea name="agencystatement" rows="30" cols="60"><?php echo $row['agencystatement']; ?></textarea></td>
</tr>
<tr class="ssi-text">
