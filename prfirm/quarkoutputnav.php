	...
	<script>			
		function gotoletter(letter, type) 
		{
			switch (type) {
				...
				case 'geo_intl':
					document.forms[0].fieldvalue.value = letter;
					document.forms[0].action = "quarkgeo_international.php";
					document.forms[0].submit();
					break;
				case 'cat':
					document.forms[0].fieldvalue.value = letter;
...
<tr>
    <td class="bodytext">
		<form method="post" target="view">
			...
			<br>
			<a href="javascript:gotoletter('0','intl')">International (OLD)</a><br>
			<br>
			<a href="javascript:gotoletter('0','cat')">Categories</a><br>
			<br>		
			<a href="javascript:gotoletter('0','geo')">Geographical - US</a><br>
			<br>
			<a href="javascript:gotoletter('0','geo_intl')">Geographical - International</a><br>
			<br>
