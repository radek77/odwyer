	...
	<html>
		...
		<tr>
			...
			<?php 
				...
				$query = 'SELECT id, name, city, state, phone, inactive, userid, validated FROM prfirm WHERE inactive = 0 AND ';
				...
				$query2 = 'SELECT count(*) as mcount FROM prfirm WHERE inactive = 0 AND ';
