			...
			if (confirm(sText))
			{
				switch (sTabID)
				{
					case 'maininfo':
						...
						return true;
						break;
					case 'agencystatement':
						top.main.edit.location.href = "editagencyform.php?sessionid=<?php echo $session->SessionID ?>&id=<?php echo $_GET['id'] ?>";
						return true;
						break;
					case 'clients':
	...
	<form method="post">
		...
		<table cellspacing="0" cellpadding="0" border="0">
			<tr class="ssi-tab">
				...
				<td id="tab2" height="21" bgcolor="#b5bad7" align="center"><a href="javascript:if(navigatetab('agencystatement')){changetab('imgl2','imgr2','tab2','agencystatement');}"><b>Agency Statement</b></a></td>
