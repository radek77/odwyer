...
<tr>
    <td class="bodytext">
		<form method="post" action="list.php" target="list">
			...
			<input name="fieldname" type="hidden" value="company"/>
			<input name="fieldvalue" type="hidden" value=""/>
			<table cellspacing="2" cellpadding="2" border="0">
				<tr class="bodytext">
				    <td><!-- <a href="alphalist.php?sessionid=<?php echo $session->SessionID; ?>" target="_self">Alphabetically</a> <b>|</b> <a href="misclist.php?alpha=af&sessionid=<?php echo $session->SessionID; ?>" target="main">With Misc Info A-F</a> <b>|</b> <a href="misclist.php?alpha=gm&sessionid=<?php echo $session->SessionID; ?>" target="main">With Misc Info G-M</a> <b>|</b> <a href="misclist.php?alpha=ns&sessionid=<?php echo $session->SessionID; ?>" target="main">With Misc Info N-S</a> <b>|</b> <a href="misclist.php?alpha=tz&sessionid=<?php echo $session->SessionID; ?>" target="main">With Misc Info T-Z</a> --></td>
				</tr>
				<tr class="bodytext">
				    <td>
				    | 
