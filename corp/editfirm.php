...
<frameset rows="25,*" border="0">
    <frame name="tab" src="edittab.php?sessionid=<?php echo $session->SessionID; ?>&id=<?php echo $_GET['id']; ?>" marginwidth="0" marginheight="0" scrolling="no" frameborder="0" border="0" noresize="no">
    <frame name="edit" src="editmainform.php?sessionid=<?php echo $session->SessionID; ?>&id=<?php echo $_GET['id']; ?>" marginwidth="0" marginheight="0" scrolling="yes" frameborder="0" border="0" noresize="auto">
</frameset>
</html>	
<?php
	}
