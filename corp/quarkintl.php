<?php 
	...
	$query = 'SELECT * FROM prfirm WHERE country <> "" and inactive = 0 and (isnull(organization) or organization = 0) ORDER BY country, name';
	...
	{
		if($country == strtoupper($row['country']))
		{
			$country = strtoupper($row['country']);
		}else{			
			$country = strtoupper($row['country']);
			$text = $text . "@BREAKER:" . $country . "\r\n\r\n";
		}
