...
<tr class="ssi-text">
    ...
    <td><input value="<?php echo $row['contactphone']; ?>" type="text" name="contactphone" size="15"> 800 Phone: <input value="<?php echo $row['phone800']; ?>" type="text" name="phone800" size="15"></td>
</tr>
<tr class="ssi-text">
    <td align="right">President/CEO:</td>
    <td><input value="<?php echo $row['presceo']; ?>" type="text" name="presceo" size="60"></td>
</tr>
<tr class="ssi-text">
    <td align="right">President/CEO Title:</td>
    <td><input value="<?php echo $row['ceotitle']; ?>" type="text" name="ceotitle" size="60"></td>
</tr>
<tr class="ssi-text">
    <td align="right">Revenue:</td>
    <td> <input value="<?php echo $row['sales']; ?>" type="text" name="sales" size="20"></td>
</tr>
<tr class="ssi-text">
...
<tr class="ssi-text">
    <td align="right">Notes From Call Center:</td>
    <td><textarea name="notes" rows="5" cols="60"><?php echo $row['notes']; ?></textarea></td>
</tr>
<tr class="ssi-text">
